...
const Team = ({ battle }) => {
  ...
  return (
    <div ref={wrapperRef} className="relative">
      <p ref={battleText} className={`bg-linear bg-clip-text text-transparent font-passion z-10 w-full text-[47px] mt-3 text-center absolute ${battle ? 'block' : 'hidden'}`}>Battle tested and forged in fire</p>
